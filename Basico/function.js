...
console.log(
	"<---------------Funcion que nos da los milisegundos y luego los cambia------------->"
);
...
const coverStringToNumber2 = function (string) {
	return Number(string);
};

console.log(coverStringToNumber2("4"));

// Funcion flecha

const coverStringToNumber3 = (string) => Number(string);

const number = coverStringToNumber3("45");
